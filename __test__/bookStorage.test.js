...
describe('Testing method getPriceWithoutExtras', () => {
    ...
    describe('Test 1: Testing all the ids in storage',() => {
...
describe('Testing method getPriceOfTheExtras', () => {
    ...
    describe('Test 1: Testing all the ids in storage',() => {
            ...
            test.each(testValues)('getPriceOfTheExtras(%s) returns %s',(id,expected) => {
    ...
    test('Test 2: nothing found with given id', () => {
        expect(() => storage.getPriceOfTheExtras(10));
    });

    test('Test 3: no id given', () => {
        expect(() => storage.getPriceOfTheExtras());
    });
});
